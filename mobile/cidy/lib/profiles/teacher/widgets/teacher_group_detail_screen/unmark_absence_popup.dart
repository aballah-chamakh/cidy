...
class UnmarkAbsencePopup extends StatefulWidget {
  ...
  @override
  State<UnmarkAbsencePopup> createState() => _UnmarkAbsencePopupState();
}

class _UnmarkAbsencePopupState extends State<UnmarkAbsencePopup> {
  ...
  Future<void> _unmarkAttendance() async {
    ...
    try {
      ...
      final url = Uri.parse(
        '${Config.backendUrl}/api/teacher/groups/${widget.groupId}/students/unmark_absence/',
      );
      ...
      if (response.statusCode == 200) {
        ...
        final dynamic rawList =
            responseData['students_without_enough_absent_classes_to_unmark'];
                ...
                children: [
                  ...
                  RichText(
                    ...
                    text: TextSpan(
                      ...
                      children: <TextSpan>[
                        const TextSpan(text: "Annuler l'absence de "),
                        TextSpan(
