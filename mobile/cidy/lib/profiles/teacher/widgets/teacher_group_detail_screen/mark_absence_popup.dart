...
class MarkAbsencePopup extends StatefulWidget {
  ...
  @override
  State<MarkAbsencePopup> createState() => _MarkAttendancePopupState();
}

class _MarkAttendancePopupState extends State<MarkAbsencePopup> {
  ...
  Future<void> _markAttendance() async {
    ...
    try {
      ...
      final url = Uri.parse(
        '${Config.backendUrl}/api/teacher/groups/${widget.groupId}/students/mark_absence/',
      );
                          ...
                          children: [
                            ...
                            RichText(
                              ...
                              text: TextSpan(
                                ...
                                children: <TextSpan>[
                                  const TextSpan(text: "Marquer l'absence de "),
                                  TextSpan(
